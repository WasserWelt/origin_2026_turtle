...
/*********************************CAN接收ID*******************************************/
#define BIG_YAW_DM6006_RecID 0x300           // CAN1,下板需要接收大yaw的电机位置数据用于底盘跟随云台
#define GIMBAL_TO_CHASSIS_FIRST_RecID 0x10  // CAN1,来自云台板发送的遥控器数据
#define GIMBAL_TO_CHASSIS_SECOND_RecID 0x11 // CAN1,来自云台板发送的导航+裁判系统数据
// ============== 底盘舵电机ID (已移除，改用全向轮) ==============
